...
const NAV_ITEMS = [
  ...
  { label: 'Laporan', href: '/admin/reports', icon: (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 17v-2m3 2v-4m3 4V8m2-4H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2z" />
    </svg>
  ) },
  ...
  return (
    ...
    `}>
      <div className={`h-16 flex items-center border-b border-white/[0.06] shrink-0 ${collapsed ? 'justify-center px-0' : 'gap-2.5 px-5'}`}>
        ...
        {!collapsed && <span className="text-base font-medium text-white/100 whitespace-nowrap">GA Admin</span>}
      </div>
